...
export type ActivityPeriod = 'today' | '7days' | '30days';
...
export function ActivityTimeline({ activity, period, onPeriodChange }: ActivityTimelineProps) {
    const emptyText = period === 'today' ? '今日尚無更新' : period === '7days' ? '過去七天無更新' : '過去30天無更新';
    return (
        <div className="glass-section">
            ...
            <div style={TAB_STYLE}>
                {(['today', '7days', '30days'] as ActivityPeriod[]).map(p => (
                    <button
                        key={p}
                        type="button"
